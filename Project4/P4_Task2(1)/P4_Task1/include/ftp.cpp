...
//send USER to the ftp server using the command USER and wait for confirmation (331)
...
void ftp_t::USER(const char *user_name)
{
...
void ftp_t::PASS(const char *pass)
{
...
void ftp_t::RETR(const char *file_name)
{
  char buf_request[255];
  std::string str_server_ip;
  std::string str_rsp;
